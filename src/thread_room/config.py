...
AGENT_CATALOG: list[dict[str, str]] = [
    {
        ...
        "adapter": "mock",
        "label": "Mock",
        "desc": "Floor: mock — offline test agent (no API)",
    },
    {
        "id": "codex",
        "adapter": "codex_cli",
        "label": "Codex",
        "desc": "Floor: live — OpenAI Codex CLI (codex on PATH)",
    },
    {
        "id": "claude",
        "adapter": "claude_code",
        "label": "Claude",
        "desc": "Floor: mock — desk is interactive; headless adapter not wired",
    },
    {
        "id": "gemini",
        "adapter": "gemini_cli",
    ...
    },
    {
        ...
        "adapter": "mock",
        "label": "Grok",
        "desc": "Floor: mock — placeholder desk; adapter not wired",
    },
]
